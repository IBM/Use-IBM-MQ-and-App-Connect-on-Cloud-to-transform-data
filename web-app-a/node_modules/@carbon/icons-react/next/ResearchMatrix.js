...
var ResearchMatrix = /*#__PURE__*/React__default['default'].forwardRef(function ResearchMatrix(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("research--matrix has been replaced by matrix. As a result, the ResearchMatrix component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
ResearchMatrix.propTypes = iconPropTypes.iconPropTypes;

module.exports = ResearchMatrix;
