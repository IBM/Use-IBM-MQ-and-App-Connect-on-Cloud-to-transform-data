...
var LogoStumbleupon = /*#__PURE__*/React__default['default'].forwardRef(function LogoStumbleupon(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("logo--stumbleupon has been removed (#4210). As a result, the LogoStumbleupon component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
LogoStumbleupon.propTypes = iconPropTypes.iconPropTypes;

module.exports = LogoStumbleupon;
