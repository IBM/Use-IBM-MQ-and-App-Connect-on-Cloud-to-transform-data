...
var EditFilter = /*#__PURE__*/React__default['default'].forwardRef(function EditFilter(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("The edit-filter icon has been replaced by filter--edit. As a result, the EditFilter component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
EditFilter.propTypes = iconPropTypes.iconPropTypes;
