...
var BackToTop = /*#__PURE__*/React__default['default'].forwardRef(function BackToTop(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("The back-to-top icon has been replaced by up-to-top. As a result, the BackToTop component will be removed in the next major version of @carbon/icons-react.");
    }
  }
