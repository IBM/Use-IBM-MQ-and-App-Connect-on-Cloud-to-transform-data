...
var Delete = /*#__PURE__*/React__default['default'].forwardRef(function Delete(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("The delete icon has been replaced by trash-can. As a result, the Delete component will be removed in the next major version of @carbon/icons-react.");
    }
  }
