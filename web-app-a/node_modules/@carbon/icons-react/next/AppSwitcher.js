...
var AppSwitcher = /*#__PURE__*/React__default['default'].forwardRef(function AppSwitcher(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("The app switcher icon has been replaced by switcher. As a result, the AppSwitcher component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
AppSwitcher.propTypes = iconPropTypes.iconPropTypes;
