...
var ResearchHintonPlot = /*#__PURE__*/React__default['default'].forwardRef(function ResearchHintonPlot(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("research--hinton-plot has been replaced by hinton-plot. As a result, the ResearchHintonPlot component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
ResearchHintonPlot.propTypes = iconPropTypes.iconPropTypes;

module.exports = ResearchHintonPlot;
