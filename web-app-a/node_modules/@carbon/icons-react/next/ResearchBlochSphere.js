...
var ResearchBlochSphere = /*#__PURE__*/React__default['default'].forwardRef(function ResearchBlochSphere(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("research--bloch-sphere has been replaced by bloch-sphere. As a result, the ResearchBlochSphere component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
ResearchBlochSphere.propTypes = iconPropTypes.iconPropTypes;

module.exports = ResearchBlochSphere;
