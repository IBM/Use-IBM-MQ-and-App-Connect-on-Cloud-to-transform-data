...
var MisuseAlt = /*#__PURE__*/React__default['default'].forwardRef(function MisuseAlt(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("The misuse--alt icon has been replaced by misuse--outline. As a result, the MisuseAlt component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
MisuseAlt.propTypes = iconPropTypes.iconPropTypes;

module.exports = MisuseAlt;
