...
var LogoGoogle = /*#__PURE__*/React__default['default'].forwardRef(function LogoGoogle(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("logo--google has been removed (#5342). As a result, the LogoGoogle component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
LogoGoogle.propTypes = iconPropTypes.iconPropTypes;

module.exports = LogoGoogle;
