...
var MammogramStacked = /*#__PURE__*/React__default['default'].forwardRef(function MammogramStacked(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("mammogram--stacked has been removed (#3152). As a result, the MammogramStacked component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
MammogramStacked.propTypes = iconPropTypes.iconPropTypes;

module.exports = MammogramStacked;
