...
var LogoDelicious = /*#__PURE__*/React__default['default'].forwardRef(function LogoDelicious(_ref, ref) {
  ...
  if (process.env.NODE_ENV !== "production") {
    if (!didWarnAboutDeprecation) {
      ...
      console.warn("logo--delicious has been removed (#4210). As a result, the LogoDelicious component will be removed in the next major version of @carbon/icons-react.");
    }
  }
...
LogoDelicious.propTypes = iconPropTypes.iconPropTypes;

module.exports = LogoDelicious;
