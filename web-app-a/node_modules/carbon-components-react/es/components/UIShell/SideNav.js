...
import { CARBON_SIDENAV_ITEMS } from './_utils'; // TO-DO: comment back in when footer is added for rails
...
var SideNav = /*#__PURE__*/React.forwardRef(function SideNav(props, ref) {
  ...
  var expandedProp = props.expanded,
      ...
      other = _objectWithoutProperties(props, ["expanded", "defaultExpanded", "isChildOfHeader", "aria-label", "aria-labelledby", "children", "onToggle", "className", "isFixedNav", "isRail", "isPersistent", "addFocusListeners", "addMouseListeners", "onOverlayClick"]);
