...
var ExampleDropContainerApp = function ExampleDropContainerApp(props) {
  ...
  var labelClasses = (0, _classnames3.default)("".concat(prefix, "--file--label"), _defineProperty({}, "".concat(prefix, "--file--label--disabled"), props.disabled));
  var helperTextClasses = (0, _classnames3.default)("".concat(prefix, "--label-description"), _defineProperty({}, "".concat(prefix, "--label-description--disabled"), props.disabled));
  ...
  }, "Max file size is 500kb. Supported file types are .jpg and .png."), /*#__PURE__*/_react.default.createElement(_FileUploaderDropContainer.default, _extends({}, props, {
