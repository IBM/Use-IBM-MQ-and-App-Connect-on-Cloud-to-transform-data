...
var _ContextMenuOption = _interopRequireDefault(require("./ContextMenuOption"));
...
function ContextMenuRadioGroupOptions(_ref) {
  ...
  var _useState = (0, _react.useState)(initialSelectedItem),
  ...
  var options = items.map(function (option, i) {
    ...
    return /*#__PURE__*/_react.default.createElement(_ContextMenuOption.default, {
      key: i,
      role: "menuitemradio",
      "aria-checked": isSelected,
      renderIcon: isSelected ? _iconsReact.Checkmark16 : null,
      label: option,
      indented: true,
...
var _default = ContextMenuRadioGroupOptions;
